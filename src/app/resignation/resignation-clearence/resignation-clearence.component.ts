...
@Component({
  selector: 'app-resignation-clearence',
  templateUrl: './resignation-clearence.component.html',
  styleUrls: ['./resignation-clearence.component.sass']
})
export class ResignationClearenceComponent implements OnInit {
